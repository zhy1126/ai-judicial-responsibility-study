...
for(const name of ['index.html','styles.css','app.js','study-core.js','study-session.js','study-content.js','study-narration.js','role-media.js','speech-input.js','audio-config.js','404.html','robots.txt','sitemap.xml','.nojekyll']){
...
for(const asset of ['styles.css','app.js','study-core.js','study-session.js','study-content.js','study-narration.js','role-media.js','speech-input.js','audio-config.js']){
